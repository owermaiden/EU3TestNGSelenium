...
public class ActionsTest {
    ...
    public void hoverTest() throws InterruptedException {
        ...
        Thread.sleep(2000);
        actions.moveToElement(img1).perform();//hover...complete with perform...do it
    ...
    public void dragAndDrop() throws InterruptedException {
        ...
        // accept cookies draggable objesini kapatıyor olabilir.. o yüzden seçip accept cookies yaptık...
        ...
        Thread.sleep(1000);
        // findelements methodu nosuchelements ikazı vermediği için size ile kontrol ediyoruz...size>0 ise böyle bir eleman var demektir..
