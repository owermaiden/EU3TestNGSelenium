...
//    }
    ...
    public void printTable(){
        ...
        System.out.println(table.getText()); // whole table text is called here
    ...
    public void getCellInRelationToAnotherCellInSameRow(){
        ...
        // table may change but, we are locating this column with name...
        String xpath ="//table[@id='table1']//td[.='"+firstName+"']/../td[3]"; // one level up than locate again down
